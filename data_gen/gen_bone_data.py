...
for dataset in datasets:   
    for set in sets:         # 'train', 'val'
        print(dataset, set)
        data = np.load('F:/Desktop/SCO-HGCN/SCO-HGCN-master/data/{}/{}_data_joint.npy'.format(dataset, set))            
        N, C, T, V, M = data.shape
        fp_sp = open_memmap(
            'F:/Desktop/SCO-HGCN/SCO-HGCN-master/data/{}/{}_data_bone.npy'.format(dataset, set),
            dtype='float32',
            mode='w+',
            shape=(N, 3, T, V, M))
